...
class inftFrame extends JPanel{
    ...
    inftFrame(){
     ...
     //傳入完整的一筆顧客資料字串陣列(ftData),然後將此顧客資料適當轉換後,存入資料庫的factory資料表中
       public void insertRD_into_TB_factory(String[] ftData){
             ...
             //在posdb資料庫中, 新增一筆顧客資料到資料表: factory  
             try{  
                    ...
                    JOptionPane.showMessageDialog(null,"在posdb資料庫中, 成功寫入一筆[廠商記錄]到factory資料表中!");
                    statement.close();

             } catch(SQLException e){
                    JOptionPane.showMessageDialog(null,"在posdb資料庫中, 寫入一筆[廠商記錄]到factory資料表中發生錯誤!");
             }
        } 
    ...
    public ActionListener ProcessBtnPress = new ActionListener(){
       public void actionPerformed(ActionEvent e){
         ...
         if(e.getSource() == myBtn3){ 
        	 inftFrame.this.setVisible(false);  //關閉視窗
         }
